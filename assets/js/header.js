(function () {
    ...
    var CSS = [
        ...
        'header.site-header .sh-nav a.sh-nav-live { color: #ff4c4c; font-weight: 700; }',
        'header.site-header .sh-nav a.sh-nav-live:hover { color: #ff7070; }',
        ...
        '    0%, 100% { opacity: 1; box-shadow: 0 0 0 2px rgba(255,255,255,0.35), 0 0 6px 2px rgba(255,76,76,0.7); }',
        '    50% { opacity: 0.3; box-shadow: 0 0 0 2px rgba(255,255,255,0.15); }',
        '}',
        '.nav-dot {',
        '    width: 10px;',
        '    height: 10px;',
        ...
        '    box-shadow: 0 0 0 2px rgba(255,255,255,0.35), 0 0 6px 2px rgba(255,76,76,0.7);',
        '    animation: navDotBlink 1.2s ease-in-out infinite;',
        '    flex-shrink: 0;',
        '}',
    ...
    function buildHeader() {
        ...
        return [
            ...
            '      <ul>',
            '        <li><a href="https://www.youtube.com/@OŠKKamennáPoruba/live" target="_blank" rel="noopener noreferrer" class="sh-nav-live">Live Stream <span class="nav-dot"></span></a></li>',
            '        <li><a href="/"><i class="fas fa-home"></i> Domov</a></li>',
            '        <li><a href="/vedenie">Vedenie klubu</a></li>',
            '        <li><a href="/atim">A-tím</a></li>',
            '        <li><a href="/akademia">Akadémia</a></li>',
            '        <li><a href="/matches">Zápasy</a></li>',
            '        <li><a href="/tabulka">Tabuľka</a></li>',
